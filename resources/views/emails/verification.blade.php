...
<body style="background-color: #09090b; color: #f8fafc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; margin: 0; padding: 40px 10px; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
    <div class="container" style="max-width: 580px; margin: 0 auto; background-color: #18181b; border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div style="padding: 0 32px 32px 32px;">
            <h2 style="color: #ffffff; font-size: 20px; font-weight: 700; margin-top: 0; margin-bottom: 12px; text-align: center;">Welcome to the Future of Wealth!</h2>
            <p style="color: #a1a1aa; font-size: 15px; line-height: 1.6; margin-bottom: 24px; text-align: center;">
                Thank you for registering. Verify your email address to unlock your account and claim your free <strong>${{ setting('signup_bonus', 7) }} Signup Bonus</strong>.
            </p>
            
            <p style="color: #ffffff; font-size: 14px; font-weight: 600; text-align: center; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px;">Your 6-Digit Verification Code</p>
            <div style="text-align: center; margin: 20px 0;">
                <div style="display: inline-block; background-color: #09090b; border: 1px solid #3b82f6; color: #3b82f6; font-size: 32px; font-weight: bold; letter-spacing: 6px; padding: 16px 36px; border-radius: 8px; box-shadow: 0 0 15px rgba(59, 130, 246, 0.15);">{{ $code }}</div>
            </div>
            
            <p style="color: #a1a1aa; font-size: 14px; line-height: 1.6; text-align: center; margin-top: 24px; margin-bottom: 0;">
                This code is valid for 30 minutes. If you did not request this account, you can safely ignore this security notification.
            </p>
        </div>
